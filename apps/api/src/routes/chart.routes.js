...
import { getChart, getDoctorRecords, updateChartSummary, verifyChart } from "../controllers/chart.controller.js";
...
router.get("/records", asyncHandler(getDoctorRecords));
router.get("/doctor/records", asyncHandler(getDoctorRecords));
